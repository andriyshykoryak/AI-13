...
int main() {
    ...
    // Крок 1: фактична ємність з урахуванням деградації за роки, Вт·год
    ...
    // Крок 3: корисна енергія, що дійде до приладу через інвертор, Вт·год
    double e_useful = e_stored * efficiency / 100.0;
    // Крок 4: втрати енергії на перетворенні напруги в інверторі, Вт·год
    double e_loss = e_stored - e_useful;

    // Крок 5: час роботи приладу від накопиченої корисної енергії, год
    double t_hours = e_useful / power;
    // Крок 6: повні години роботи — ціла частина часу
    int hours = static_cast<int>(t_hours);
    // Крок 7: хвилини понад повні години — ціла частина залишку часу, помножена на 60
